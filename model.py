    ...
    while(1):
        try:
            ...
            input_sentence = 'q'
               ...
               output = "Sorry! I do not know a word in your input yet."
               break
    return output
...
# torch.save(encoder, 'encoder2.pkl')
# torch.save(decoder, 'decoder2.pkl')
# torch.save(voc, 'voc2.pkl')
